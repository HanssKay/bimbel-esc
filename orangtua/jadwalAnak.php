            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center">
                <div>
                    ...
                    <p class="text-gray-600">
                        Lihat jadwal belajar anak Anda
                    </p>
                </div>
                                    ...
                                    <div class="flex items-center mb-4">
                                        ...
                                        <div class="ml-3">
                                            <h4 class="font-bold text-gray-900">
                                                <?php echo htmlspecialchars($anak['nama_lengkap']); ?></h4>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="font-medium text-gray-900">
                                                    <?php echo htmlspecialchars($jadwal['nama_lengkap']); ?></div>
                                            </td>
                                            ...
                                            <td>
                                                <span
                                                    class="badge <?php echo $jadwal['jenis_kelas'] == 'Excellent' ? 'badge-excellent' : 'badge-champion'; ?>">
                                                    <?php echo $jadwal['jenis_kelas']; ?>
                                                </span>
                                            </td>
                                            <td>
                                                <div class="font-medium">
                                                    <?php echo htmlspecialchars($jadwal['nama_pelajaran']); ?></div>
                                            </td>
                                            <td>
