...
<head>
    ...
    <style>
        ...
        .progress-fill.info { background-color: #8b5cf6; }
        
        .amount-card {
            border-left: 4px solid;
        }
        
        .amount-card.total { border-left-color: #3b82f6; }
        .amount-card.paid { border-left-color: #10b981; }
        .amount-card.due { border-left-color: #ef4444; }
                ...
                <div class="stat-card amount-card paid bg-white rounded-xl shadow p-5">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <h3 class="text-2xl font-bold text-gray-800">Rp <?= number_format($total_dibayar, 0, ',', '.') ?></h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="stat-card bg-white rounded-xl shadow p-5 border-l-4 border-purple-500">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <h3 class="text-2xl font-bold text-gray-800"><?= $lunas_count + $dibebaskan_count ?> Lunas</h3>
                ...
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center">
                    ...
                    <div class="flex flex-col md:flex-row gap-3 w-full md:w-auto">
                        ...
                        <form method="GET" class="flex flex-col md:flex-row gap-3">
                            ...
                            <a href="?" class="px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 flex items-center justify-center">
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                <th class="px-6 py-3 text-left text-xs text-center  font-medium text-gray-500 uppercase tracking-wider">
                                    Bulan Tagihan
                                </th>
                                <th class="px-6 py-3 text-left text-xs text-center font-medium text-gray-500 uppercase tracking-wider">
                                    Anak
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="table-row hover:bg-gray-50 transition-colors duration-150">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 h-10 w-10 bg-gradient-to-r from-blue-100 to-blue-50 rounded-full flex items-center justify-center">
                                ...
                                <td class="px-6 py-4">
                                    <div class="space-y-2 ">
                                        ...
                                        <div class="grid md:grid-cols-2 text-sm">
                                            ...
                                            <span class="font-medium <?= $pembayaran['status'] == 'lunas' ? 'text-green-600' : 'text-gray-900' ?>">
                                        ...
                                        <div class="grid md:grid-cols-2 text-sm">
                                            ...
                                            <span class="font-medium text-red-600">
                                                Rp <?= number_format(floatval($pembayaran['nominal_tagihan']) - floatval($pembayaran['nominal_dibayar']), 0, ',', '.') ?>
                                            </span>
                                        </div>
                                        <?php endif; ?>
                ...
                <div class="px-6 py-4 border-t border-gray-200 bg-gray-50">
                    <div class="flex flex-col md:flex-row justify-between items-center">
                        <div class="text-sm text-gray-600 mb-2 md:mb-0">
                            ...
                            <?php if (!empty($siswa_filter)): ?>
                            untuk <?= htmlspecialchars($siswa_list[array_search($siswa_filter, array_column($siswa_list, 'id'))]['nama_lengkap'] ?? 'anak terpilih') ?>
                            <?php endif; ?>
                        </div>
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <div class="flex justify-between items-center">
                            ...
                            <button onclick="closeDetail()" class="text-white hover:text-blue-200 text-xl bg-transparent border-none cursor-pointer">
                            ...
                            <div class="detail-value">
                                <div class="progress-container">
                                    <div class="progress-label">
                                        ...
                                        <span>${persentase.toFixed(0)}%</span>
                                    </div>
                                    <div class="progress-bar">
                                        <div class="progress-fill ${statusColor}" style="width: ${persentase}%"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
